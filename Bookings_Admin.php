<?php
	...
	//Create query
	$qry="select * from booking order by Booking_No DESC";
	$result1=mysql_query ("select count(*) as total from booking where Status_Checked = 'Not yet checked!'");
	$COUNT_NUMBER=mysql_fetch_array($result1);
	
	$result3=mysql_query ("select count(*) as total from booking where Status_Confirmed  = 'Not yet approved!'");
	$COUNT_NUMBER2=mysql_fetch_array($result3);
	
	$result2=mysql_query ("select count(*) as total from booking");
	$COUNT_NUMBER1=mysql_fetch_array($result2);
...
function getConfirmation()
{
	...
	if(retVal == true){
	alert("Administrator want to continue!");
return  true;}
else{
	alert("Administrator does not want to continue!");
}
}
</script>
 <script type='text/javascript'>
...
<table style="position:absolute;left:204px;top:427px;width:820px;height:502px;z-index:14;" cellpadding="0" cellspacing="1" id="Table1">
<tr><td><h4><center><?php echo "All Bookings =".$COUNT_NUMBER1[0]; ?>&nbsp;&nbsp;|&nbsp;&nbsp;|&nbsp;&nbsp;<?php  echo "Not Yet Checked bookings = " .$COUNT_NUMBER[0]; ?>&nbsp;&nbsp;<a href="Bookings_Admin1.php"><img src="images/arn.png" id="Image6" alt="" border="0" style="width:20px;height:20px;"></a>&nbsp;&nbsp;|&nbsp;&nbsp;|&nbsp;&nbsp; <?php echo "Not Yet Confirmed bookings =".$COUNT_NUMBER2[0]; ?>&nbsp;&nbsp;<a href="Bookings_Admin2.php"><img src="images/arn.png" id="Image6" alt="" border="0" style="width:20px;height:20px;"></a></center></h4></td></tr>
<tr><td><center><a href="Bookings_Admin3.php" style="color:#000"><h4>Click Here To Be Able To Select All Bookings Between Two Dates</h4></a><br><input type='button' class='btn btn-success' id='btnprint' value='Print' onclick='print_page()' /></center></td></tr>
<tr>
 ...
 while ($member = mysql_fetch_array ($result)) {
		...
		echo "  <table  border='0'  >
			  ...
			  <tr><td width='750'><font color='#000'><b>Date of booking :</b>{$member['date_of_booking']}</td></tr>
		        ...
		        <tr><td><form action='bookingChecked.php'  method='post'><tr><td ><font color='#000'><input type='hidden'  name='bookNo' id='bookNo' value ='{$member['Booking_No']}' /><input type='hidden'  name='emailA' id='emailA' value ='{$member['Email_Ad']}' /><br><input type='submit' name='Submit' class='btn btn-success' style='width:300px;height:25px;z-index:22; background-color:#00FF00;' value='Click Here To Mark This Booking Checked' /></td></tr></form>
