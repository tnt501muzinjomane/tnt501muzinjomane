...
<title>Testimonials from our customers</title>
...
<img src="images/img0087.gif" id="Shape5" alt=""></div>
<div id="wb_Text1" style="position:absolute;left:369px;top:394px;width:470px;height:24px;text-align:center;z-index:11;">
<span style="color:#000000;font-family:Arial;font-size:21px;"><strong>Testimonials From Our Customers</strong></span></div>
...
<ul id="TabMenu1">
<li><a href="./Testimonial_Admin.php" class="active">View Testimonials</a></li>
		...
		echo "  <table  border='0'>
			  ...
			  <tr><td width='750'><font color='#000'><br><hr><b>From :{$member['Name']}&nbsp;&nbsp;{$member['Surname']}</b></td></tr>
			   <tr><td width='750'><font color='#000'><b>Email :</b><a href='mailto:{$member['Email_Ad']}' style=c'olor:#000>'{$member['Email_Ad']}</a></td></tr>
				...
				<tr><td><form action='testimonialDeleted.php'  method='post'><tr><td ><font color='#000'><input type='hidden'  name='testId' id='testId' value ='{$member['Testimonial_Id']}' /><br><input type='submit' class='btn btn-danger' name='Submit' 
				
				style='width:300px;height:25px;z-index:22; background-color:#FF0000;'
			
				 value='Delete This Testimonial' /></td></tr>
				</form>
