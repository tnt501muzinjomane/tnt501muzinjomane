...
<body>
<div id="container">
<div id="SlideShow1" style="position:absolute;left:387px;top:51px;width:687px;height:282px;z-index:10;">
...
<div id="wb_Image1" style="position:absolute;left:0px;top:50px;width:1199px;height:270px;z-index:11;">
<img src="images/img0030.png" id="Image1" alt="" border="0" style="width:1199px;height:270px;"></div>
<div id="wb_Shape1" style="position:absolute;left:1px;top:322px;width:1197px;height:56px;z-index:12;">
<img src="images/img0031.gif" id="Shape1" alt=""></div>
<div id="wb_Shape2" style="position:absolute;left:0px;top:0px;width:1199px;height:49px;z-index:13;">
<img src="images/img0032.gif" id="Shape2" alt=""></div>
<div id="wb_Shape3" style="position:absolute;left:0px;top:773px;width:1201px;height:199px;z-index:14;">
<img src="images/img0033.gif" id="Shape3" alt=""></div>
<div id="wb_Image2" style="position:absolute;left:1104px;top:110px;width:47px;height:46px;z-index:15;">
...
<div id="wb_Image3" style="position:absolute;left:1105px;top:162px;width:46px;height:45px;z-index:16;">
...
<div id="wb_Image4" style="position:absolute;left:1109px;top:219px;width:36px;height:37px;z-index:17;">
...
<div id="wb_Shape6" style="position:absolute;left:122px;top:383px;width:986px;height:73px;z-index:18;">
<img src="images/img0034.gif" id="Shape6" alt=""></div>
<div id="wb_Shape7" style="position:absolute;left:883px;top:459px;width:223px;height:311px;z-index:19;">
<img src="images/img0035.gif" id="Shape7" alt=""></div>
<div id="wb_Text1" style="position:absolute;left:152px;top:392px;width:652px;height:34px;text-align:center;z-index:20;">
<span style="color:#000000;font-family:Arial;font-size:29px;"><strong>Testimonials From Our Valuable Customers</strong></span></div>
<div id="wb_Text2" style="position:absolute;left:906px;top:469px;width:178px;height:29px;text-align:center;z-index:21;">
<span style="color:#000000;font-family:Arial;font-size:24px;"><strong>Contact Us</strong></span></div>
<div id="wb_SiteSearch1" style="position:absolute;left:879px;top:10px;width:276px;height:26px;z-index:22;">
...
<marquee direction="right" scrolldelay="90" scrollamount="6" behavior="alternate" loop="0" style="position:absolute;left:42px;top:285px;width:1104px;height:24px;z-index:23;" id="Marquee1" onmouseover="this.stop()" onmouseout="this.start()"><span style="color:#FFFFFF;font-family:Arial;font-size:21px;"><strong>&quot;Your Reliable Transport To OR Tambo International Airport&quot;</strong></span></marquee>
<div id="wb_Text3" style="position:absolute;left:51px;top:225px;width:299px;height:48px;text-align:center;z-index:24;">
...
<div id="wb_Shape4" style="position:absolute;left:125px;top:463px;width:747px;height:304px;z-index:25;">
<img src="images/img0036.gif" id="Shape4" alt=""></div>
<div id="wb_Shape5" style="position:absolute;left:892px;top:507px;width:205px;height:249px;z-index:26;">
<img src="images/img0047.gif" id="Shape5" alt=""></div>
<div id="wb_Text9" style="position:absolute;left:901px;top:522px;width:157px;height:80px;z-index:27;">
...
<div id="wb_Image5" style="position:absolute;left:76px;top:59px;width:288px;height:167px;z-index:28;">
<img src="images/Shuttle.png" id="Image5" alt="" border="0" style="width:288px;height:167px;"></div>
<div id="wb_Form1" style="position:absolute;left:169px;top:507px;width:658px;height:258px;z-index:29;">

<form name="Form1" method="post" action="processTestimonial.php" id="Form1">
<div id="wb_Text4" style="position:absolute;left:10px;top:9px;width:69px;height:16px;z-index:0;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Name</span></div>
<span id="sprytextfield1">
<input type="text" id="Editbox1" style="position:absolute;left:89px;top:9px;width:263px;height:23px;line-height:23px;z-index:1;" name="Editbox1" value="" >
<span class="textfieldRequiredMsg">Name required.</span></span>
<div id="wb_Text6" style="position:absolute;left:10px;top:39px;width:69px;height:16px;z-index:2;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Surname</span></div>
<span id="sprytextfield2">
<input type="text" id="Editbox2" style="position:absolute;left:89px;top:39px;width:264px;height:23px;line-height:23px;z-index:3;" name="Editbox2" value="">
<span class="textfieldRequiredMsg">Surname required.</span></span>
<div id="wb_Text7" style="position:absolute;left:10px;top:70px;width:69px;height:16px;z-index:4;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Email</span></div>
<input type="email" id="Editbox3" style="position:absolute;left:89px;top:69px;width:263px;height:23px;line-height:23px;z-index:5;" name="Editbox3" value="" placeholder="e.g. muzi@gmail.com">
<div id="wb_Text8" style="position:absolute;left:10px;top:99px;width:69px;height:32px;z-index:6;">
<span style="color:#000000;font-family:Arial;font-size:13px;">Testimonial</span></div>
<span id="sprytextarea1">
<textarea name="TextArea1" id="TextArea1" style="position:absolute;left:89px;top:99px;width:501px;height:98px;z-index:7;" rows="5" cols="77"></textarea>
<span class="textareaRequiredMsg">A value is required.</span></span>
<input type="submit" id="Button1" name="" value="Submit" style="position:absolute;left:88px;top:214px;width:96px;height:25px;z-index:8;">
<input type="reset" id="Button2" name="" value="Reset" style="position:absolute;left:233px;top:214px;width:96px;height:25px;z-index:9;">
</form>
</div>
<div id="wb_TabMenu1" style="position:absolute;left:31px;top:313px;width:1133px;height:66px;z-index:30;overflow:hidden;">
<ul id="TabMenu1">
...
<div id="wb_CssMenu1" style="position:absolute;left:147px;top:845px;width:924px;height:42px;text-align:center;z-index:31;">
<a href="index.html">Home</a>
<a href="profile.html">Profile</a>
<a href="services.html">Services</a>
<a href="https://www.facebook.com/flightconnector/photos_stream" target="_blank">Gallery</a>
<a href="bookings.php">Bookings</a>
<a href="testimonials.php">Testimonials</a>
</div>
<div id="wb_Text5" style="position:absolute;left:408px;top:902px;width:419px;height:33px;z-index:32;">
...
document.write(year)
</script> <a href="mailto:tnt501muzinjomane@gmail.com" style="color:#000">TnT Technologies Inc All Rights Reserved</a></span></div>
<div id="wb_Shape8" style="position:absolute;left:184px;top:467px;width:319px;height:40px;z-index:33;">
<img src="images/img0060.gif" id="Shape8" alt=""></div>
<div id="wb_Text10" style="position:absolute;left:196px;top:472px;width:297px;height:19px;z-index:34;">
<span style="color:#000000;font-family:Arial;font-size:16px;"><strong>Feed Your Testimonials Below</strong></span></div>
<div id="wb_Shape9" style="position:absolute;left:529px;top:466px;width:326px;height:41px;z-index:35;">
<img src="images/img0061.gif" id="Shape9" alt=""></div>
<div id="wb_Text11" style="position:absolute;left:542px;top:472px;width:305px;height:19px;z-index:36;">
<span style="color:#000000;font-family:Arial;font-size:16px;"><strong><a href="testimonials_platform.php" style="color:#000">Click Here To View Our Testimonials</a></strong></span></div>
<div id="wb_Text12" style="position:absolute;left:903px;top:617px;width:167px;height:38px;z-index:37;">
<span style="color:#000000;font-family:Arial;font-size:17px;"><strong>&nbsp; We are based in Mbabane Swaziland</strong></span></div>
<div id="wb_Image6" style="position:absolute;left:18px;top:850px;width:20px;height:20px;z-index:38;">
<a href="admin.php"><img src="images/admin.png" id="Image6" alt="" border="0" style="width:20px;height:20px;"></a></div>
</div>
<script type="text/javascript">
