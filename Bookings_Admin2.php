<?php
	...
	//Create query
	$qry="select * from booking where Status_Confirmed  = 'Not yet approved!' order by Booking_No DESC";
		...
		echo "  <table  border='0'  >
			  ...
			  <tr><td width='750'><font color='#000'><b>Country Code :</b>{$member['Country_Code']}</td></tr>
			   ...
			   <tr><td width='750'><font color='#000'><b>Email :</b><a href='mailto:{$member['Email_Ad']}' style=c'olor:#000>'{$member['Email_Ad']}</a></td></tr>
				...
				<tr><td width='750'><font color='#000'><b>Checked :</b>{$member['Status_Checked']}</td></tr>
				<tr><td width='750'><font color='#000'><b>Confirmed :</b>{$member['Status_Confirmed']}</td></tr>
