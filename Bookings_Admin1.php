<?php
	...
	//Create query
	$qry="select * from booking where Status_Checked = 'Not yet checked!' order by Booking_No DESC";
...
<tr><td><h4><center><?php echo "All Bookings =".$COUNT_NUMBER1[0]; ?>&nbsp;&nbsp;|&nbsp;&nbsp;|&nbsp;&nbsp;<?php  echo "Not Yet Checked bookings = " .$COUNT_NUMBER[0]; ?>&nbsp;&nbsp;|&nbsp;&nbsp;|&nbsp;&nbsp; <?php echo "Not Yet Confirmed bookings =".$COUNT_NUMBER2[0]; ?>&nbsp;&nbsp;<a href="Bookings_Admin2.php"><img src="images/arn.png" id="Image6" alt="" border="0" style="width:20px;height:20px;"></a><br><input type='button' class='btn btn-success' id='btnprint' value='Print' onclick='print_page()' /></center></h4></td></tr>
<tr>
